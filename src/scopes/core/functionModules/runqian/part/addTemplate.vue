...
<!--          <a class="ant-btn ant-btn-default"><ta-icon type="upload" /> 上传<input type="file" class="upload-btn" ref="file" @change="fnChooseFile"></a>-->
        ...
        <ta-form-item
          ...
          :field-decorator-options="{rules: [{ required: true, message: '请填写报表标志' }, { pattern: /^[\u4E00-\u9FA5A-Za-z0-9_.]+$/, message: '只能输入中文英文数字点及下划线' }],initialValue: record.raqfilename?record.raqfilename:'' }"
        >
        ...
        <ta-form-item
          ...
          :field-decorator-options="{rules: [{ required: true, message: '请输入报表名称' }, { pattern: /^[\u4E00-\u9FA5A-Za-z0-9_.]+$/, message: '只能输入中文英文数字点及下划线' }],initialValue: record.raqname?record.raqname:''}"
        >
          <ta-input />
        </ta-form-item>
      </ta-form>
