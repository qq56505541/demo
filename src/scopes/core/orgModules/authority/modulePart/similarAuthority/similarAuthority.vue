<template id="app">
  <ta-border-layout :layout="{left:'300px'}" :left-cfg="{showBar: true}" :footer-cfg="{showBorder: false}">
    ...
    <div>
      ...
      <ta-tabs class="define-tab-context">
        ...
        <!--挂载节点-->
        <ta-button type="primary" icon="plus-circle-o" @click="fnAuthorityToRoleModal" slot="tabBarExtraContent" :disabled="authorityDisabled" class="step2">授权</ta-button>
      </ta-tabs>
    </div>
    <div slot="centerFooter">
      <!--begin 分页信息-->
      <ta-pagination
    ...
    const steps = [
      {
        ...
        popover: {
          title: '角色列表',
          description: '可以通过左边的功能树筛选出具有相同功能权限的角色',
          position: 'bottom',
        },
      },
      {
        ...
        popover: {
          title: '授权',
          description: '对这些具有类似功能权限的角色进行批量授权',
          position: 'left',
        },
      },
    ]
