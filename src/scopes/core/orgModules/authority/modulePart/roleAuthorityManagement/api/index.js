...
export default {
  ...
  deleteBatchRoleUsers (data, callBack) {
    Base.submit(null, { url: BASE_URL + 'deleteBatchRoleUser', data: data, }, {
      successCallback: (data) => callBack(data),
    })
  },
  ...
  queryUsersByRoleIdNoPage(data, callBack) {
    Base.submit(null, { url: BASE_URL + 'queryUsersByRoleIdNoPage', data: data, }, {
      successCallback: (data) => callBack(data),
    })
  },
  ...
  queryUsersNoWraperByRoleIdNoPage (data, callBack) {
    Base.submit(null, { url: BASE_URL + 'queryUsersNoWraperByRoleIdNoPage', data: data, }, {
  ...
  addAllRoleUsersByOrgId (data, callBack) {
    Base.submit(null, { url: BASE_URL + 'addAllRoleUsersByOrgId', data: data, }, {
      successCallback: (data) => callBack(data),
    })
  },
}
