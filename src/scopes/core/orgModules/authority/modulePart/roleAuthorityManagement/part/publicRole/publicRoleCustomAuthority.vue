          ...
          <ta-row class="fit">
            ...
            >
              ...
              <ta-menu
                ...
                @click="onSelectMenu"
              >
                <ta-menu-item v-for="item in menuData" :key="item.id">
            ...
            <ta-col :span="20" class="right-box">
              <div style="border: 1px solid #e8e8e8;" class="fit">
                ...
                <div class="authority-box">
                  ...
                  />
                  <ta-button type="primary" class="button-save" @click="fnCustomAuthorityMgSave">
                    权限保存
                  </ta-button>
                  <ta-popover
                  ...
                  >
                    ...
                    <div style="float: right;margin-top: 10px;">
                      ...
                      <ta-button size="small" @click="fnSaveCustomEffectiveTime(true)">
                        设为永久
                      </ta-button>
                      <ta-button type="primary" size="small" @click="fnSaveCustomEffectiveTime(false)">
                        确定
                      </ta-button>
                    </div>
                    <ta-button
                      ...
                      <span v-if="data.checked && !data.disabled" class="node-right">
                        ...
                        >
                          ...
                          <div style="float: right;margin-top: 10px;">
                            ...
                            <ta-button size="small" @click="onCustomCellChange(node,data,true)">设为永久</ta-button>
