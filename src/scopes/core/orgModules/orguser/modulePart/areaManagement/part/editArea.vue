<template>
  <ta-form :autoFormCreate="(form)=>{this.form = form}">
    <ta-form-item
      ...
      :fieldDecoratorOptions="{rules: [{ required: true, whitespace: true, message: '行政区划名称不能为空' }, { pattern: /^[\u4E00-\u9FA5A-Za-z0-9_]+$/, message: '只能输入中文英文数字及下划线' }]}"
    >
    ...
    <ta-form-item
      ...
      :fieldDecoratorOptions="{rules: [{ required: false, message: '排序号不能为空!' }, { pattern: '^(0|[1-9][0-9]{0,3})$', message: '请输入正确的排序号' }]}"
    >
      <ta-input :disabled="flag"/>
    </ta-form-item>
