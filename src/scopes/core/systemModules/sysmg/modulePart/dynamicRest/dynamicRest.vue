<template>
  <div class="fit">
    <ta-border-layout  :centerCfg="{showBar: true}" :footer-cfg="{showBorder: false}">
    ...
    <dynamic-rest-edit :visible="formVisible" @close="closeForm" :row-data="rowData"
                  @queryTable="queryDynamic"></dynamic-rest-edit>
...
import dynamicRestEdit from './part/edit'
...
const columns = [
  ...
  { title: '服务SQL', width: '17%', overflowTooltip: true, dataIndex: 'sql', scopedSlots: { customRender: 'sql' } },
  {
    title: '服务ID',
    width: '20%',
    overflowTooltip: true,
  ...
  { title: '数据源', dataIndex: 'dsName', width: '16%', overflowTooltip: true, scopedSlots: { customRender: 'dsName' } },
  { title: '有效性', dataIndex: 'effective', width: '10%', yesOrNoTag: true, scopedSlots: { customRender: 'effective' } },
