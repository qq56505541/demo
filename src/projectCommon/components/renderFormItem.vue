...
import taSensitiveInput from '@yh/ta404-ui/es/sensitive-input'
import '@yh/ta404-ui/es/sensitive-input/style/index.less'
import { isString, isObject, } from '@yh/ta-utils'
const RENDER_TYPE = {
  ADD: 'ADD',
  EDIT: 'EDIT',
  SHOW: 'SHOW',
  ...
  methods: {
    buildItemShowContext (type) {
      ...
      switch (type) {
        ...
        case 'sensitive-input':
          ...
          const objVal = isString(val) ? JSON.parse(val) : val
    ...
    buildItemContext (type) {
      ...
      switch (type) {
        ...
        case 'radioButton':
          return (<ta-radio-group  class='lalal' buttonStyle="solid" disabled={disabled} >
            {
