<template>
  <ta-select mode="multiple" v-model="selectValue" :placeholder="placeholder" :options="CollectionData(collection)" :disabled="disabled" :allow-clear="allowClear" @change="handleChange" />
</template>
